...
# Replace with the correct API URL and your API key
API_KEY = '3'  # Replace with your TheSportsDB API key
API_URL = f'https://www.thesportsdb.com/api/v1/json/{API_KEY}/eventsday.php?s=basketball&d={{date}}'
